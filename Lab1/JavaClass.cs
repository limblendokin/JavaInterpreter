...
namespace JavaInterpreter
{
    class JavaClass
    {
        ...
        public JavaClass (uint magic, ushort minorVersion, ushort majorVersion, ushort constantPoolCount, ConstantPool constantPool,
                          ushort accessFlags, ushort thisClass, ushort superClass, ushort interfacesCount, Interfaces interfaces,
                          ushort fieldsCount, List<Field> fields, ushort methodsCount, List<Method> methods, 
                          ushort attributesCount, Attributes attributes)
        {
            this.magic = magic;
